...
public class GradebookControllerTest {
    ...
    @Test
    public void studentInformationHttpRequestStudentDoesNotExists() throws Exception {
    ...
    @Test
    public void createANonValidGradeTypeHttpRequestEmptyResponse() throws Exception {
        MvcResult mvcResult = this.mockMvc.perform(post("/grades")
                        .contentType(MediaType.APPLICATION_JSON)
                        .param("grade", "85.00")
    ...
    @Test
    public void createANonValidGradeHttpRequestEmptyResponse() throws Exception {
        MvcResult mvcResult = this.mockMvc.perform(post("/grades")
                        .contentType(MediaType.APPLICATION_JSON)
                        .param("grade", "-17.50")
                        .param("gradeType", "math")
