...
public class GradebookControllerTest {
    ...
    public void createStudentHttpRequest() throws Exception {
        ...
        CollegeStudent verifyStudent = studentDao.findByEmailAddress("christian_pasten@outlook.com");
    ...
    @Test
    public void getStudentInfoHttpRequestNotExist() throws Exception {
    ...
    @Test
    public void createGradeHttpRequestStudentNotExists() throws Exception {
        this.mockMvc.perform(post("/grades")
                        .contentType(MediaType.APPLICATION_JSON)
                        .param("grade", "85.00")
                        .param("gradeType", "math")
    ...
    @Test
    public void deleteGradeHttpRequestStudentDoesNotExist() throws Exception {
    ...
    @Test
    public void deleteGradeHttpRequestInvalidGrade() throws Exception {
